...
interface BookMetadataRepository : JpaRepository<BookMetadata, Int> {
    ...
    @Query(
            value="SELECT bm.book_id, b.title, bm.cover_type, bm.pages, bm.publisher, bm.publish_date, bm.views, bm.isbn10, bm.isbn13,\n" +
                    ...
                    "GROUP BY bm.book_id, b.title, bm.cover_type, bm.pages, bm.publisher, bm.publish_date, bm.views, bm.isbn10, bm.isbn13\n" +
                    "LIMIT :limit",
            nativeQuery=true
    )
